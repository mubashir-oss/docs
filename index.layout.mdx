...
<CardGroup cols={2}>
  ...
  >
    An interactive UI to upload documents and parse them using Unsiloed AI to visualize bounding boxes, inspect structured Markdown/JSON output, and run key-value extractions without writing code. Explore the included sample files to see how complex documents are parsed by our vision models.
  </Card>
  <Card
    title="Quickstart"
    icon="book-open"
