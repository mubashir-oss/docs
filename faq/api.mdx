...
1. **Create an account** at [unsiloed.ai](https://www.unsiloed.ai/login)
2. **Navigate to your platform dashboard** after signing up
3. **Generate API keys** in the API section
4. **Start making requests** using our endpoints
5. **Monitor usage** and track quota in your dashboard
...
- **Extraction**: `POST /extract` - Extract structured data using JSON schemas, returns job_id
