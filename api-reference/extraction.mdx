...
const response = await fetch('https://visionapi.unsiloed.ai/cite', {
  method: 'POST',
  headers: {
    'accept': 'application/json',
    'api-key': 'your-api-key'
...
<ParamField body="batch_size" type="number" default="10">
...
const response = await fetch('https://visionapi.unsiloed.ai/batch/cite', {
  method: 'POST',
  headers: {
    'accept': 'application/json',
    'api-key': 'your-api-key'
