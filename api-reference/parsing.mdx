...
<ParamField body="segmentation_strategy" type="string">
...
**`ocr_engine`** (string, optional): Select the OCR engine for text recognition:
...
formData.append('ocr_engine', 'UnsiloedStorm');
