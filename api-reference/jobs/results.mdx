...
```bash cURL
curl -X GET "https://visionapi.unsiloed.ai/jobs/b2094b38-e432-44b6-a5d0-67bed07d5de1/result" \
...
url = f"https://visionapi.unsiloed.ai/jobs/{job_id}/result"
...
const response = await fetch(`https://visionapi.unsiloed.ai/jobs/${jobId}/result`, {
  headers: {
