...
<AccordionGroup>
  <Accordion title="High-Accuracy Processing" icon="bullseye">
    ...
    **Trade-offs:**
    ...
    - **Latency**: +1-2 seconds per page for table validation
  </Accordion>

  <Accordion title="Fast Processing" icon="bolt">
  ...
  <Accordion title="Financial Documents (Tables + Charts)" icon="chart-line">
  ...
  <Accordion title="Data Extraction Only (Tables)" icon="table">
  ...
  <Accordion title="Academic/Research Documents" icon="graduation-cap">
  ...
  <Accordion title="Output Fields Optimization" icon="sliders">
...
// formData.append('merge_tables', 'true');
// formData.append('validate_table_segments', 'true');
// formData.append('keep_segment_types', 'table');
// formData.append('segmentation_method', 'smart_layout_detection');
// formData.append('ocr_mode', 'auto_ocr');
